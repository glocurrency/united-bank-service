...
class ErrorCodeFactory
{
    public static function getTransactionStateCode(ErrorCodeEnum $errorCode): TransactionStateCodeEnum
    {
        return match ($errorCode) {
            ...
            ErrorCodeEnum::UNKNOWN_ERROR => TransactionStateCodeEnum::API_MALFUNCTION,
            ...
            ErrorCodeEnum::DD_ALREADY_PAID => TransactionStateCodeEnum::API_MALFUNCTION,
            ErrorCodeEnum::NETWORK_MESSAGE_WAS_ACCEPTED => TransactionStateCodeEnum::API_MALFUNCTION,
            ErrorCodeEnum::INVALID_TRANSACTION_CODE => TransactionStateCodeEnum::API_ERROR,
            ErrorCodeEnum::CUT_OVER_IN_PROGRESS => TransactionStateCodeEnum::API_MALFUNCTION,
            ErrorCodeEnum::SERVICE_ERROR => TransactionStateCodeEnum::API_MALFUNCTION,
            ErrorCodeEnum::SERVICE_TIMEOUT => TransactionStateCodeEnum::API_MALFUNCTION,
            ...
            ErrorCodeEnum::SYSTEM_MALFUNCTION => TransactionStateCodeEnum::API_MALFUNCTION,
        };
    }
}
